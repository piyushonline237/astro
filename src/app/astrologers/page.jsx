...
const astrologers = [
  {
    ...
    status: "online",
    image: "/images/vedicastrology.png?height=300&width=300",
    description:
  ...
  },
  {
    ...
    status: "online",
    image: "/images/tarotreading.png?height=300&width=300",
    description:
  ...
  },
  {
    ...
    status: "busy",
    image: "/images/numerology.png?height=300&width=300",
    description:
  ...
  },
  {
    ...
    status: "offline",
    image: "/images/palmistry.png?height=300&width=300",
    description:
  ...
  },
  {
    ...
    status: "online",
    image: "/images/vastushastra.png?height=300&width=300",
    description:
  ...
  },
  {
    ...
    status: "online",
    image: "/images/facereading.png?height=300&width=300",
    description:
  ...
  },
  {
    ...
    status: "busy",
    image: "/images/kundlimatching.png?height=300&width=300",
    description:
  ...
  },
  {
    ...
    languages: ["English", "Hindi"],
    status: "offline",
    image: "/images/psychicreading.png?height=300&width=300",
    description:
...
export default function AstrologersPage() {
  return (
<main className="min-h-screen bg-gradient-to-r from-[#FF3CAC] via-[#562B7C] to-[#2B86C5] py-12">
