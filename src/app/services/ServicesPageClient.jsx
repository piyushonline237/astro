...
const services = [
  {
    ...
    price: "₹999",
    duration: "45 minutes",
    image: "/images/personalhoroscoprreading.png",
  },
  {
    id: 2,
    ...
    price: "₹1,499",
    duration: "60 minutes",
    image: "/images/RelationshipCompatibility.png",
  },
  {
    id: 3,
    ...
    price: "₹1,299",
    duration: "50 minutes",
    image: "/images/SpiritualGrowthConsultation.png",
  },
  {
    id: 4,
                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap justify-between items-center mb-4">
                      <div className="text-amber-400 font-semibold text-xl mb-2 md:mb-0">{service.price}</div>
